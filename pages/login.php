                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="../indexlogged.php">
                                        ...
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user"
                                                ...
                                                placeholder="Enter your email..." value="<?php if (isset($_COOKIE['email'])) { echo $_COOKIE['email'];} ?>">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                ...
                                                <label class="custom-control-label" for="remember_check">Remember Me</label>
                                            </div>
                                        </div>
